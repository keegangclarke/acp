...
for name in mkt_names:
    MKT = name
    print('Beginning process on '+MKT)
    ...
    print('Plotting remaining graphs.')
    # %%
    # Get predictions
...
print('Finished process for '+MKT+'\n')